			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						newHeaders.set('referer', 'https://www.google.com/search?q=t.me/cT8cT');
...
<a href='https://github.com/3Kmfi6HP/t.me/cT8cT' target='_blank'>t.me/cT8cT - https://github.com/3Kmfi6HP/t.me/cT8cT</a>
...
<a href='v2rayng://install-config?url=${encodeURIComponent(subbestip)}' target='_blank'>v2rayNG优选IP自动</a></p>`;
	...
	const htmlHead = `
  <head>
	<title>t.me/cT8cT: VLESS configuration</title>
	<meta name='description' content='This is a tool for generating VLESS protocol configurations. Give us a star on GitHub https://github.com/3Kmfi6HP/t.me/cT8cT if you found it useful!'>
	<meta name='keywords' content='t.me/cT8cT, cloudflare pages, cloudflare worker, severless'>
	<meta name='viewport' content='width=device-width, initial-scale=1'>
	<meta property='og:site_name' content='t.me/cT8cT: VLESS configuration' />
	<meta property='og:type' content='website' />
	<meta property='og:title' content='t.me/cT8cT - VLESS configuration and subscribe output' />
	...
	<meta name='twitter:title' content='t.me/cT8cT - VLESS configuration and subscribe output' />
...
function createVLESSSub(userID_Path, hostName) {
	...
	const output = userIDArray.flatMap((userID) => {
		const httpConfigurations = Array.from(portSet_http).flatMap((port) => {
			if (!hostName.includes('pages.dev')) {
				...
				return proxyIPs.flatMap((proxyIP) => {
					const vlessSecHttp = `vless://${userID}@${proxyIP}:${port}${commonUrlPart_http}${urlPart}-${proxyIP}-t.me/cT8cT`;
		...
		const httpsConfigurations = Array.from(portSet_https).flatMap((port) => {
			...
			return proxyIPs.flatMap((proxyIP) => {
				const vlessSecHttps = `vless://${userID}@${proxyIP}:${port}${commonUrlPart_https}${urlPart}-${proxyIP}-t.me/cT8cT`;
